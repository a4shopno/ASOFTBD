...
public class WebviewFragment extends Fragment {
    ...
    public WebviewFragment(int pos, String Title) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.wv = (WebView) rootView.findViewById(R.id.webView1);

        this.progressbar = (ProgressBar) rootView.findViewById(R.id.progressBar1);
